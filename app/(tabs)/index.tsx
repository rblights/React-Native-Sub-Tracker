    ...
    const upcomingSubscriptions = useMemo(() => {
        ...
        return subscriptions
            ...
            .map(sub => {
                ...
                const diff = dayjs(sub.renewalDate).diff(now, 'day');
                
                // Return a new object with the daysLeft property injected
                return {
                    ...sub,
                    daysLeft: diff <= 0 ? 0 : diff // Ensure we don't show negative numbers
                };
            })
